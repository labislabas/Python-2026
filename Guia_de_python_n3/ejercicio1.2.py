...
impedancia_total = impedancia_1 + impedancia_2


impedancia_real = int(impedancia_total.real)


impedancia_imag = int(impedancia_total.imag)


print(f"Impedancia total: {impedancia_total} |  Impedancia real: {impedancia_real} | Impedancia imaginaria: {impedancia_imag}")